...
export default function Footer() {
  ...
  return (
    <footer style={{ borderTop: '1px solid rgba(255,255,255,.08)', background: 'rgba(8,6,18,.5)' }}>
      <div className="fm-footer-grid" style={{ maxWidth: '1200px', margin: '0 auto', padding: '52px 20px 28px' }}>
        ...
        <div style={{ minWidth: '200px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '7px', marginBottom: '13px' }}>
            <img src="/logo.png" alt="Fama Mennou" style={{ height: '30px', width: 'auto', objectFit: 'contain', mixBlendMode: 'screen' }} />
            <span style={{ fontWeight: 700, fontSize: '16px', color: '#fbfbff', fontFamily: "'Plus Jakarta Sans',sans-serif" }}>
              Fama<span style={{ color: '#9b8cff' }}>&nbsp;Mennou</span>
            </span>
          </div>
          <p style={{ fontSize: '13.5px', color: '#7e82a0', lineHeight: 1.6, maxWidth: '250px', margin: '0 0 18px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            ...
            <a href="https://youtube.com/@famamennou?si=6xCP4zz2yXrpS3gA" target="_blank" rel="noopener noreferrer"
              style={{ width: '36px', height: '36px', borderRadius: '10px', background: 'rgba(255,255,255,.06)', border: '1px solid rgba(255,255,255,.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#a7abc8', transition: 'background .15s,color .15s,border-color .15s' }}
              ...
              onMouseLeave={e => { e.currentTarget.style.background = 'rgba(255,255,255,.06)'; e.currentTarget.style.color = '#a7abc8'; e.currentTarget.style.borderColor = 'rgba(255,255,255,.1)'; }}
              title="YouTube">
        ...
        {/* Platform */}
        <div>
          <div style={{ fontSize: '12px', fontWeight: 700, letterSpacing: '.08em', color: '#62668a', marginBottom: '13px', textTransform: 'uppercase' }}>
            {t('Platform')}
          </div>
      ...
      {/* Bottom bar */}
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '18px 20px', borderTop: '1px solid rgba(255,255,255,.05)', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '12px' }}>
        <p style={{ fontSize: '12.5px', color: '#62668a', margin: 0 }}>
          © {new Date().getFullYear()} Fama Mennou. {t('All rights reserved.')}
        </p>
        <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
          <span style={{ width: 7, height: 7, borderRadius: '50%', background: '#10b981', boxShadow: '0 0 7px #10b981', flexShrink: 0, display: 'inline-block' }} />
          <span style={{ fontSize: '12.5px', color: '#62668a' }}>{t('All systems operational')}</span>
        </div>
      </div>
    </footer>
  );
