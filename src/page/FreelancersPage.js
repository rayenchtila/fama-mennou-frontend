        ...
        <div style={{ display:'flex', flexDirection:'column', alignItems:'stretch', gap:10, flexShrink:0, width:168 }}>
          ...
          {isOwn ? (
            <a href="/dashboard?tab=profile"
              style={{ display:'flex', alignItems:'center', justifyContent:'center', gap:6, padding:'10px 0', borderRadius:12, background:'linear-gradient(135deg,#7c6cf6,#6254d4)', border:'none', color:'#fff', fontSize:13, fontWeight:700, textDecoration:'none', boxShadow:'0 4px 16px -4px rgba(124,108,246,0.5)', transition:'opacity .15s' }}
