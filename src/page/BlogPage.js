    ...
    <>
      ...
      <div style={{ minHeight: '100vh', background: '#0a0817', paddingTop: 100, paddingBottom: 80 }}>
        <div style={{ maxWidth: 800, margin: '0 auto', padding: '0 24px', textAlign: 'center' }}>
          <span style={{ fontSize: 12, fontWeight: 700, letterSpacing: '.1em', textTransform: 'uppercase', color: '#9b8cff' }}>Blog</span>
          <h1 style={{ fontSize: 42, fontWeight: 900, color: '#fbfbff', margin: '12px 0 16px', letterSpacing: '-0.02em' }}>
            Actualités & Conseils
          </h1>
          <p style={{ fontSize: 17, color: '#a7abc8', lineHeight: 1.8, maxWidth: 500, margin: '0 auto 56px' }}>
          ...
          <div style={{ padding: '56px 32px', borderRadius: 24, background: 'rgba(124,108,246,0.06)', border: '1px solid rgba(124,108,246,0.15)' }}>
            ...
            <h2 style={{ fontSize: 22, fontWeight: 800, color: '#fbfbff', margin: '0 0 10px' }}>Bientôt disponible</h2>
            <p style={{ fontSize: 15, color: '#a7abc8', margin: 0 }}>Notre blog arrive très bientôt avec des articles exclusifs sur le freelancing, la formation et le marché tunisien.</p>
          </div>
        </div>
      </div>
    </>
