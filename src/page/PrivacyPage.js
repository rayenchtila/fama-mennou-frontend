...
const SECTIONS = [
  {
    ...
    content: "Nous collectons les informations que vous nous fournissez lors de l'inscription : nom, email, date de naissance, région, genre, photo de profil et photos CIN. Nous collectons également des données d'utilisation anonymisées pour améliorer la plateforme.",
    color: '#9b8cff',
    icon: <svg width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg>,
  },
  {
    title: "2. Utilisation des données",
    content: "Vos données sont utilisées pour : créer et gérer votre compte, vérifier votre identité (CIN), faciliter les transactions entre freelancers et clients, envoyer des notifications importantes par email, et améliorer nos services.",
    color: '#3ec2e8',
  ...
  },
  {
    ...
    content: "Toutes les données sensibles (mots de passe, photos CIN) sont chiffrées. Nous ne vendons jamais vos données à des tiers. L'accès aux données est strictement limité à l'équipe Fama Mennou.",
    color: '#10b981',
  ...
  {
    title: "4. Cookies",
    content: "Nous utilisons des cookies essentiels pour maintenir votre session de connexion et mémoriser vos préférences. Nous n'utilisons pas de cookies publicitaires.",
    color: '#f59e0b',
  ...
  },
  {
    ...
    content: "Vos informations publiques de profil (nom, compétences, bio, portfolio) sont visibles par les autres utilisateurs. Votre email, date de naissance et CIN restent privés.",
    color: '#a78bfa',
  ...
  {
    title: "6. Vos droits",
    content: "Vous pouvez à tout moment : accéder à vos données, les modifier via votre profil, ou demander la suppression de votre compte en nous contactant à famamennou.platform@gmail.com.",
    color: '#34d399',
  ...
  {
    title: "8. Contact",
    content: "Pour toute question relative à la confidentialité : famamennou.platform@gmail.com",
    color: '#fb923c',
      ...
      <div style={{ minHeight: '100vh', background: 'var(--fm-bg)', paddingTop: 100, paddingBottom: 80 }}>
        <div style={{ maxWidth: 760, margin: '0 auto', padding: '0 24px' }}>
          <div style={{ textAlign: 'center', marginBottom: 52 }}>
            ...
            <h1 style={{ fontSize: 42, fontWeight: 900, color: 'var(--fm-text-1)', margin: '12px 0 16px', letterSpacing: '-0.02em' }}>Politique de Confidentialité</h1>
