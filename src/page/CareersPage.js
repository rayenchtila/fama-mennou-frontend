    ...
    <>
      ...
      <div style={{ minHeight: '100vh', background: 'var(--fm-bg)', paddingTop: 100, paddingBottom: 80 }}>
        <div style={{ maxWidth: 800, margin: '0 auto', padding: '0 24px', textAlign: 'center' }}>
          <span style={{ fontSize: 12, fontWeight: 700, letterSpacing: '.1em', textTransform: 'uppercase', color: 'var(--fm-primary-light)' }}>Carrières</span>
          ...
          <div style={{ padding: '56px 32px', borderRadius: 24, background: 'rgba(124,108,246,0.06)', border: '1px solid rgba(124,108,246,0.15)', marginBottom: 32 }}>
            ...
            <h2 style={{ fontSize: 22, fontWeight: 800, color: 'var(--fm-text-1)', margin: '0 0 10px' }}>Aucun poste ouvert pour le moment</h2>
            <p style={{ fontSize: 15, color: 'var(--fm-text-5)', margin: '0 0 24px' }}>Revenez bientôt ou envoyez-nous votre candidature spontanée.</p>
